...
const BLOCKED_JOB_PATTERNS: Array<{ pattern: RegExp; message: string }> = [
  {
    pattern: /بدون\s+(?:نقل\s+)?(?:خدمات|كفال[هة])/,
