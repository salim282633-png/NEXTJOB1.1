...
export const SAUDI_GUIDE_ARTICLES: GuideArticle[] = [
  ...
  {
    id: 'guide-cv-a4-tips',
    title: 'كيف تجهز سيرة ذاتية A4 مختصرة وواضحة؟',
    category: 'نصائح التوظيف والمقابلات',
    cluster: 'السيرة الذاتية والمقابلات',
    summary: 'طريقة عملية لترتيب بياناتك المهنية ومهاراتك وخبرتك بصورة سهلة القراءة.',
    readTime: '3 دقائق قراءة',
    date: '2026-08-23',
    iconName: 'Sparkles',
    content: [
      'ابدأ بالمهنة والمدينة الحالية ووسيلة تواصل صحيحة ثم لخص الخبرات الأهم.',
      'اذكر المهارات التي تستخدمها فعليًا وأسماء البرامج أو المعدات ذات الصلة بالوظيفة.',
      'تجنب المعلومات غير الصحيحة أو المبالغة في الخبرة والمؤهلات.',
      'اجعل التصميم بسيطًا وقابلًا للطباعة والقراءة على الهاتف.'
    ]
  },
  {
    id: 'guide-relocation-riyadh-jeddah',
    title: 'ما الذي تراجعه قبل الانتقال لمدينة أخرى من أجل العمل؟',
    category: 'تجارب وحرف اليمنيين',
    cluster: 'المدن والفرص',
    summary: 'قائمة عملية لمقارنة العرض الوظيفي وتكاليف السكن والنقل قبل الانتقال.',
    readTime: '4 دقائق قراءة',
    date: '2026-08-21',
    iconName: 'MapPin',
    content: [
      'قارن صافي الدخل بعد السكن والمواصلات والطعام، وليس الراتب الاسمي فقط.',
      'تحقق من موقع العمل ووقت التنقل وتوفر وسائل النقل قبل الموافقة.',
      'اسأل عن السكن أو بدل السكن والمواصلات إن كانت ضمن العرض، وتأكد من توثيق ما تم الاتفاق عليه.',
      'لا تعتمد على تقديرات عامة للأسعار وحدها؛ راجع الأسعار الحالية في المدينة وقت اتخاذ القرار.'
    ]
  }
];
