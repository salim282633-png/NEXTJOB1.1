...
const OVERRIDES = {
  ...
  'yemeni-jobs-saudi-jobs-25065961': {
    title: 'البحث عن عمل في السعودية: خطوات عملية وآمنة',
  ...
  'yemeni-jobs-saudi-jobs-98305259': {
    title: 'البحث عن عمل ونقل الخدمات في السعودية: دليل تحقق',
  ...
  'yemeni-jobs-saudi-jobs-9c0f8017': {
    title: 'دليل البحث عن عمل في السعودية وخطوات التقديم',
