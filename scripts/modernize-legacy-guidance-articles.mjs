...
const SAFE_ROLE = 'NEXT JOB مركز إرشادي مستقل للعمل والمسار المهني. يقدم محتوى وأدلة عامة تساعد الباحث على تنظيم خطواته والتحقق من المعلومات، ولا يستقبل طلبات التوظيف نيابة عن أصحاب العمل ولا يضمن الحصول على وظيفة أو نقل الخدمات.';
