...
const replacements = [
  ...
  ['دليل عملي ومتجدد حول البحث عن الوظائف، تجهيز الملف المهني، المدن والمهن، نقل الخدمات، والتقديم الآمن — دون ادعاءات توظيف أو وعود غير موثوقة.', 'مركز إرشادي متجدد يساعدك على تنظيم البحث عن عمل، تطوير الملف المهني، فهم العقود ونقل الخدمات، والاستفادة من أدلة المدن والمهن بأمان.'],
