...
const USER_AGENT = 'NEXTJOB-yemeni-audience-filter/1.0';
...
const TARGET_ROLE_RULES = [
  {
    ...
    title: 'حارس أمن',
    category: 'security',
    patterns: [/\bsecurity guard\b/i, /\bsecurity officer\b/i, /حارس\s+أمن/, /حراسة\s+أمنية/]
  },
  {
    key: 'driver',
    title: 'سائق',
    category: 'drivers',
    patterns: [/\bdriver\b/i, /\bchauffeur\b/i, /سائق/]
  },
  {
    key: 'delivery',
    title: 'مندوب توصيل',
    category: 'drivers',
    patterns: [/\bdelivery (?:driver|rider|courier)\b/i, /\bcourier\b/i, /مندوب\s+توصيل/, /عامل\s+توصيل/]
  },
  {
    key: 'sales-representative',
    title: 'مندوب مبيعات',
    category: 'sales',
    patterns: [/\bsales representative\b/i, /\bsales rep\b/i, /\bsales executive\b/i, /\bsales agent\b/i, /\bfield sales\b/i, /مندوب\s+مبيعات/, /مسوق\s+ميداني/]
  },
  {
    key: 'sales-associate',
    title: 'بائع / موظف متجر',
    category: 'sales',
    patterns: [/\bsales associate\b/i, /\bretail associate\b/i, /\bstore associate\b/i, /\bshop assistant\b/i, /\bretail sales\b/i, /\bsalesman\b/i, /\bsaleswoman\b/i, /\bsales person\b/i, /بائع/, /موظف\s+متجر/]
  },
  {
    key: 'cashier',
    title: 'كاشير',
    category: 'sales',
    patterns: [/\bcashier\b/i, /كاشير/, /أمين\s+صندوق/]
  },
  {
    key: 'customer-service',
    title: 'موظف خدمة عملاء',
    category: 'sales',
    patterns: [/\bcustomer service (?:agent|representative|associate)\b/i, /\bcustomer support (?:agent|representative|associate)\b/i, /\bcall center agent\b/i, /خدمة\s+عملاء/, /مركز\s+اتصال/]
  },
  {
    key: 'restaurant-worker',
    title: 'عامل مطعم',
    category: 'restaurants',
    patterns: [/\brestaurant (?:worker|crew|staff|team member)\b/i, /\bcrew member\b/i, /\bfood service worker\b/i, /عامل\s+مطعم/, /موظف\s+مطعم/]
  },
  {
    key: 'cook',
    title: 'طباخ',
    category: 'restaurants',
    patterns: [/\bcook\b/i, /\bchef\b/i, /طباخ/, /شيف/]
  },
  {
    key: 'kitchen-helper',
    title: 'مساعد مطبخ',
    category: 'restaurants',
    patterns: [/\bkitchen helper\b/i, /\bkitchen assistant\b/i, /\bkitchen crew\b/i, /مساعد\s+مطبخ/, /عامل\s+مطبخ/]
  },
  {
    key: 'barista',
    title: 'باريستا',
    category: 'restaurants',
    patterns: [/\bbarista\b/i, /باريستا/]
  },
  {
    key: 'waiter',
    title: 'مقدم طعام',
    category: 'restaurants',
    patterns: [/\bwaiter\b/i, /\bwaitress\b/i, /\bserver\b/i, /نادل/, /مقدم\s+طعام/]
  },
  {
    key: 'warehouse-worker',
    title: 'عامل مستودع',
    category: 'warehousing',
    patterns: [/\bwarehouse worker\b/i, /\bwarehouse associate\b/i, /\bpicker\b/i, /\bpacker\b/i, /\bmaterial handler\b/i, /عامل\s+مستودع/, /عامل\s+مخزن/, /منتقي\s+طلبات/]
  },
  {
    key: 'storekeeper',
    title: 'أمين مستودع',
    category: 'warehousing',
    patterns: [/\bstorekeeper\b/i, /\bwarehouse keeper\b/i, /أمين\s+مستودع/, /أمين\s+مخزن/]
  },
  {
    key: 'cleaner',
    title: 'عامل نظافة',
    category: 'maintenance',
    patterns: [/\bcleaner\b/i, /\bcleaning worker\b/i, /\bhousekeeper\b/i, /عامل\s+نظافة/, /نظافة/]
  },
  {
    key: 'general-worker',
    title: 'عامل',
    category: 'general',
    patterns: [/\bgeneral worker\b/i, /\blaborer\b/i, /\blabourer\b/i, /\bhelper\b/i, /عامل\s+عام/, /عامل\b/]
  },
  {
    key: 'operations-coordinator',
    title: 'منسق عمليات',
    category: 'general',
    patterns: [/\boperations coordinator\b/i, /\boperations associate\b/i, /\boperations assistant\b/i, /منسق\s+عمليات/, /مساعد\s+عمليات/]
  },
  {
    key: 'technician',
    title: 'فني',
    category: 'technical',
    patterns: [/\btechnician\b/i, /\bmaintenance technician\b/i, /\belectrician\b/i, /\bplumber\b/i, /فني/, /كهربائي/, /سباك/]
  },
  {
    key: 'receptionist',
    title: 'موظف استقبال',
    category: 'general',
    patterns: [/\breceptionist\b/i, /\bfront desk\b/i, /موظف\s+استقبال/, /استقبال/]
  },
  {
    key: 'promoter',
    title: 'مروج مبيعات',
    category: 'sales',
    patterns: [/\bpromoter\b/i, /\bbrand promoter\b/i, /مروج\s+مبيعات/, /مروج/]
  },
  {
    key: 'merchandiser',
    title: 'مسؤول ترتيب وعرض المنتجات',
    category: 'sales',
    patterns: [/\bmerchandiser\b/i, /\bmerchandising associate\b/i, /مرتب\s+أرفف/, /عرض\s+المنتجات/]
  }
];
...
const ARABIC_COMPANY_NAMES = new Map([
  ...
  ['BRKZ', 'بركز'],
  ['SOUM', 'سوم'],
  ['Infinite pl', 'إنفنت بي إل'],
  ['Lalamove', 'لالاموف'],
  ['dLocal', 'دي لوكال'],
  ['Contentsquare', 'كونتنت سكوير']
]);
...
function stripLocationNoise(value) {
  return String(value || '')
    ...
    .replace(/kingdom of saudi arabia/gi, ' ')
    .replace(/المملكة العربية السعودية/g, ' ')
    .replace(/داخل السعودية/g, ' ')
    .replace(/في السعودية/g, ' ');
}
...
function isSaudiRestricted(text) {
  return hasAny(stripLocationNoise(plainText(text)), SAUDI_RESTRICTION_PATTERNS);
}

function hasExplicitYemeniAudience(text) {
  return hasAny(plainText(text), YEMENI_PRIORITY_PATTERNS);
}
...
function inferTargetRole(title) {
  ...
  for (const rule of TARGET_ROLE_RULES) {
    if (rule.patterns.some(pattern => pattern.test(normalized))) {
      if (senior && !['security-guard', 'driver', 'delivery', 'cook', 'barista', 'waiter', 'cleaner', 'general-worker'].includes(rule.key)) {
        return null;
      }
      return rule;
    }
...
function qualificationScore(level) {
  if (level === 'بدون شهادة جامعية') return 25;
  if (level === 'ثانوية عامة') return 20;
  if (level === 'دبلوم') return 10;
...
function qualificationSentence(level) {
  ...
  if (level === 'شهادة جامعية مطلوبة') return 'الإعلان يشترط مؤهلًا جامعيًا.';
...
function buildArabicDescription({ company, city, explicitYemeni, roleTitle, qualificationLevel }) {
  const audience = explicitYemeni
    ? 'الإعلان يذكر اليمنيين أو الجنسية اليمنية بصورة صريحة، ولذلك أعطي أولوية مرتفعة في العرض.'
    : 'تم ترشيح الوظيفة لأنها من الأعمال التشغيلية والبسيطة الأكثر ملاءمة للفئة المستهدفة.';
  return [
    `فرصة ${roleTitle} في ${city} لدى ${company}.`,
    audience,
    qualificationSentence(qualificationLevel),
...
function scoreJob({ explicitYemeni, role, qualificationLevel, sourcePublishedAt }) {
  const audienceScore = explicitYemeni ? 100 : 0;
  const roleScore = role ? 45 : 0;
  const recencyDays = Math.max(0, (Date.now() - Date.parse(sourcePublishedAt || 0)) / 86_400_000);
  const recencyScore = Number.isFinite(recencyDays) ? Math.max(0, 10 - Math.min(10, recencyDays)) : 0;
...
function validateTargetFeed(jobs) {
  ...
  for (const job of jobs) {
    ...
    if (!allowedQualifications.has(job.qualificationLevel)) {
      throw new Error(`${job.id}: unsupported qualificationLevel.`);
    }
    if (typeof job.targetRole !== 'string' || !job.targetRole.trim()) {
      throw new Error(`${job.id}: targetRole is required.`);
    }
    if (typeof job.audienceLabel !== 'string' || !job.audienceLabel.trim()) {
      throw new Error(`${job.id}: audienceLabel is required.`);
    }
    if (!Number.isFinite(job.priorityScore)) throw new Error(`${job.id}: priorityScore is required.`);
    if (isSaudiRestricted(`${job.title} ${job.description} ${job.audienceLabel}`)) {
      throw new Error(`${job.id}: Saudi-national restriction leaked into targeted feed.`);
    }
    if (/[A-Za-z]{3,}/.test(String(job.description || ''))) {
      throw new Error(`${job.id}: public description must stay Arabic.`);
    }
  }
}
...
async function main() {
  ...
  const processed = await mapLimit(jobs, 6, async job => {
    ...
    return {
      ...
      sourceName: 'المصدر الرسمي للوظيفة',
      sourceLocation: city,
      language: 'ar',
      audienceLabel: explicitYemeni ? 'مطلوب يمنيون صراحة' : 'مناسب للفئة المستهدفة',
      qualificationLevel,
  ...
  console.log(`Audience targeting complete: ${output.length}/${jobs.length} job(s) kept, Arabic-only public display enforced.`);
}
